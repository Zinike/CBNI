    ...
    <section id="propiedades">
      ...
      <div class="contenedor">
        <form class="cards">
            ...
            <div class="card">
              <div class="foto"><img src="<?php echo $row['FOTO'];?>" alt="imagen" max-width="200px" max-height="200px"></div>
      ...
      <div class="contenedor">
        <form class="cards">
            ...
            while ($row=mysqli_fetch_assoc($resultado)) {?>
            <div class="card">
              <div class="foto"><img src="<?php echo $row['FOTOS'];?>" alt="imagen" max-width="200px" max-height="200px"></div>
              <div class="nombre"><p><?php echo $row['TIPO'];?></p></div>
              <div class="descripcion"><p><?php echo $row['DESCRIPCION'];?></p></div>
            </div>
            <?php }?>
